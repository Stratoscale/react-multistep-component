    ...
    return (
      React.Children.map(children, (child, index) => {
        ...
        let settings = {
          ...
          isSibling: this.props.mountOnlyActive ? false : this.props.mountOnlySiblings ? isSibling : true
        };
        return (
          // child.type === <Step/>
          <child.type {...settings}>
  ...
  _printNav(currentStep, childrenLength) {
    ...
    const finishButton = this.props.finishButton ?
      ...
      >
        {currentStep < childrenLength && this.props.intermediateFinishButton ?
          this.props.intermediateFinishButton : this.props.finishButton}
      </button> : null;
    ...
    return (
      <div className="steps-nav">
        ...
        { currentStep < childrenLength && Boolean(this.props.showFinish) ? finishButton: null }
      </div>
    )
  }
